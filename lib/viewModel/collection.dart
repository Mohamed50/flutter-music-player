...
//       }
//     }
//     if (isFileSupported(file) && !isAlreadyPresent) {
//       try {
...
//         Track track = await Track.fromMap(trackMap);
...
//           this.playlists.last.tracks.add(await Track.fromMap(track));
//         }
//       }
//     }
//     this.notifyListeners();
...
//       this._albums[binaryIndexOf(this._foundAlbums, [track.albumName, track.albumArtistName])].tracks.add(
//         new Track(
//           albumName: track.albumName,
//           year: track.year,
//           albumArtistName: track.albumArtistName,
